 ...
 * Invocation command was nin10kit --mode=3 --resize=240x160 gamebackground gamebackground.jpeg 
 * Time-stamp: Friday 11/12/2021, 01:24:08
 * 
 * Image Information
 * -----------------
 * gamebackground.jpeg 240@160
 * 
